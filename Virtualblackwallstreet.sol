...
contract VirtualBlackwallstreet is Context, IERC20, Ownable {
    ...
    string private _name = "VirtualBlackWallS";      //CHANGE_REQUIRED: name of token
    string private _symbol = "VBWS";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
